...
# 1. Downloads the dog-vs-cat dataset
# 2. Fine-tunes an InceptionV3 model on the dog-vs-cat training set.
# 3. Evaluates the model on the dog-vs-cat validation set.
#
# Usage:
# cd slim
# ./slim/scripts/finetune_inception_v3_on_dog-vs-cat.sh
set -e
...
TRAIN_DIR=data/work_dirs/dog-vs-cat-models/inception_v3
