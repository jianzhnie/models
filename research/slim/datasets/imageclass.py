...
SPLITS_TO_SIZES = {'train': None, 'validation': None}
...
def get_split(dataset_dir, dataset_name, split_name, file_pattern=None, reader=None):
  ...
  if dataset_utils.has_dataset_split_file(dataset_dir, dataset_name):
    train_val_num_dict = dataset_utils.read_dataset_split_file(dataset_dir, dataset_name)

  return slim.dataset.Dataset(
      data_sources=file_pattern,
      reader=reader,
      decoder=decoder,
      num_samples=train_val_num_dict[split_name],
