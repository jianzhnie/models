...
def replace_input_nodes(original_graph_def,
                        original_input_name,
                        new_input_name,
    ...
    graph = tf.import_graph_def(original_graph_def,
...
if __name__ == '__main__':
    # 输入ckpt模型路径
    input_checkpoint='data/work_dirs/flowers-models/inception_v3/model.ckpt-1000'
    # 输出pb模型的路径
    out_pb_path="data/work_dirs/flowers-models/inception_v3/frozen_model.pb"
