...
def main(unused_argv):
    ...
    ####
    print(
        f"python exporter_main_v2.py --input_type=image_tensor  --pipeline_config_path={FLAGS.pipeline_config_path} --trained_checkpoint_dir={FLAGS.output_path} --output_directory={os.path.join(FLAGS.output_path, 'export')}")
    os.system(
        f"python exporter_main_v2.py --input_type=image_tensor  --pipeline_config_path={FLAGS.pipeline_config_path} --trained_checkpoint_dir={FLAGS.output_path} --output_directory={os.path.join(FLAGS.output_path, 'export')}")
